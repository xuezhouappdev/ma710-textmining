...
* 8.[Future Studies](#8)   #corpus, 3-gram, Wekas package, topic modeling 

The following R file contains the functions we used in this report. We will explain the related functions in the corresponding code blcok accordingly.
...
--------- | ----- | ------
Query term | "google" | Interested in modern dance.
...
N-grams    | 1, 2 |
Stopwords  | "english"/"SMART" |
Stopwords  | "google" | This is the search term.
Weighting  | binary | 
Threshold  | 2 |
`k`        | 10 |
