...
* 5.1 [Individual Variable Summary](#5.1)
  ...
  * 5.1.2 Student Body
    ...
    * 5.1.2.3 [Median Family Income in Real 2015 Dollars](#5.1.2.3)
  * 5.1.3 Cost 
  ...
  * 5.1.5 Repayment
    * 5.1.5.1 [3-year Repayment rate](#5.1.5.1)
    * 5.1.5.2 [3-year Default rate](#5.1.5.2)
...
* 4.[Base investigation](#investi0)
  ...
  * 4.3 [Cluster Evaluation](#4.3)
    ...
    * 4.3.3 [Subjective Evaluation (terms and documents in each cluster)]
